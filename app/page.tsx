      ...
      <section className="py-20 px-4">
        <div className="container mx-auto text-center max-w-4xl">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Connect with compatible roommates in your area. Our smart matching
            system helps you find someone who shares your lifestyle, budget, and
            living preferences.
          </p>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Our algorithm matches you based on lifestyle, budget,
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Chat safely with potential roommates through our built-in
                messaging system
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Tell us about yourself, your lifestyle, and what you're looking
                for in a roommate
              </p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Our smart algorithm finds compatible roommates based on your
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Chat with matches, meet up, and find your perfect living
                situation
              </p>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                "Found my perfect roommate in just 2 weeks! The matching system
                really works - we have so much in common."
              </p>
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                "The verification process made me feel so much safer. I knew I
                was talking to real, trustworthy people."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              <p className="text-gray-600 mb-4">
                "Not only did I find a great roommate, but we've become best
                friends! The lifestyle matching is spot on."
              </p>
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                Government ID required for all users
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl text-green-500 mb-4">✅</div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600">
                No personal info shared until you're ready
              </p>
            </div>
            <div className="text-center">
              <div className="text-4xl text-green-500 mb-4">✅</div>
      ...
      <section id="podcast" className="py-20 px-4 bg-gray-50">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Real stories, expert tips, and roommate advice
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">🎧</div>
              <h3 className="text-xl font-semibold mb-2">
                Episode 12: Red Flags to Avoid
              </h3>
              <p className="text-gray-600 mb-4">
                Learn the warning signs of problematic roommates and how to spot
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">🎧</div>
              <h3 className="text-xl font-semibold mb-2">
                Episode 11: Setting Boundaries
              </h3>
              <p className="text-gray-600 mb-4">
                How to establish healthy boundaries with your roommate from day
                one for a harmonious living situation.
              </p>
              <div className="flex items-center justify-between">
            ...
            <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
              <div className="text-4xl mb-4">🎧</div>
              <h3 className="text-xl font-semibold mb-2">
                Episode 10: Budget Conversations
              </h3>
              <p className="text-gray-600 mb-4">
                Navigate money talks with potential roommates and ensure you're
                both on the same financial page.
              </p>
              <div className="flex items-center justify-between">
      ...
      <section id="blog" className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              Tips, guides, and insights for better shared living
            </p>
          </div>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <article className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  The Ultimate Roommate Agreement Template
                </h3>
                <p className="text-gray-600 mb-4">
                  Download our comprehensive template to set clear expectations
                  and avoid conflicts before they start.
                </p>
                <div className="flex items-center justify-between">
                  <span className="text-sm text-gray-500">5 min read</span>
                  <button className="text-cyan-800 hover:text-cyan-700 font-medium">
                    Read More
                  </button>
                </div>
              </div>
            ...
            <article className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <p className="text-gray-600 mb-4">
                  Practical strategies for maintaining a clean shared space
                  without constant arguments or resentment.
                </p>
                <div className="flex items-center justify-between">
            ...
            <article className="bg-white border border-gray-200 rounded-lg overflow-hidden hover:shadow-lg transition-shadow">
              ...
              <div className="p-6">
                ...
                <h3 className="text-xl font-semibold mb-2">
                  Splitting Bills: Apps and Methods That Work
                </h3>
                <p className="text-gray-600 mb-4">
                  Compare the best apps and strategies for managing shared
                  expenses and keeping finances transparent.
                </p>
                <div className="flex items-center justify-between">
      ...
      <section className="py-20 px-4 bg-cyan-800 text-white">
        <div className="container mx-auto text-center">
          ...
          <p className="text-xl mb-8 opacity-90 max-w-2xl mx-auto">
            Join thousands of people who have found their ideal living situation
            through Roomies
          </p>
